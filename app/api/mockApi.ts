...
export const mockAccounts: Account[] = [
  { id: 1, name: 'Courant BNP', balance: 1500, bankId: 1, type: 'checking' },
  { id: 2, name: 'Livret A', balance: 5000, bankId: 1, type: 'savings' },
  { id: 3, name: 'PEL', balance: 7000, bankId: 2, type: 'investment' },
  { id: 4, name: 'Compte Joint', balance: 3000, bankId: 3, type: 'checking' },
  { id: 5, name: 'PEA', balance: 10000, bankId: 2, type: 'investment' },
  { id: 6, name: 'CTO', balance: 12000, bankId: 2, type: 'investment' },
  { id: 7, name: 'Fake expense', balance: 0, bankId: 4, type: 'expense' },
  { id: 8, name: 'Fake income', balance: 0, bankId: 4, type: 'income' }
];
...
export const mockTransactions: Transaction[] = [
  ...
  { id: 6, date: '2023-03-12', description: 'Dinner', amount: 100.00, type: 'expense', fromAccountId: 4, toAccountId: 8, category: { name: 'Food', subCategories: [] } },
  ...
  { id: 11, date: '2023-03-11', description: 'Coffee', amount: 5.00, type: 'expense', fromAccountId: 4, toAccountId: 8, category: { name: 'Food', subCategories: [] } },
];
